...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<body>
		...
		<!-- end:fh5co-header -->
		<div class="fh5co-parallax" style="background-image: url(images/CrossImpact.png);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
						<div class="fh5co-intro fh5co-table-cell animate-box">
							<h1 class="text-center" style="text-shadow: 1px 1px 40px blue;">Our  Mentors</h1>
							<p> Lets Get Started  <a href="#">Mentor</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="fh5co-team-section">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<div class="heading-section text-center animate-box">
							<h2>Meet Our Awesome Mentors</h2>
				...
				<div class="row text-center">
					<div class="col-md-4 col-sm-6">
						<div class="team-section-grid animate-box" style="background-image: url(images/trainer-1.jpg);">
							<div class="overlay-section">
								<div class="desc">
									<h3>Reece Reece</h3>
									<span>Chief Executive Officer/ Fitness Trainer / Life Coach Mentor </span>
					...
					<div class="logo col-md-4 col-sm-6 col-lg-6 img-responsive"></div>
					     <div class="container">
                         	   <div class="row">
                         	   	<img class="img-responsive animate-box col-lg-4" src="images/reece2.jpeg" width="400" alt="About">
                         	   	<img class="img-responsive animate-box  col-lg-4" src="images/reece1.png" width="400" alt="About">
                         	   	<img class="img-responsive animate-box col-lg-4" src="images/reece0.jpeg" width="400" alt="About">
                         	   </div>
                         </div>
				<!--	<div class="col-md-4 col-sm-6">
						...
						<div class="team-section-grid animate-box" style="background-image: url(images/trainer-4.jpg);">
							<div class="overlay-section">
								<div class="desc">
									...
									<p>"If you want something you never had before , then do something you never done before."</p>
									<p class="fh5co-social-icons">
										<a href="#"><i class="icon-twitter-with-circle"></i></a>
										<a href="#"><i class="icon-facebook-with-circle"></i></a>
										<a href="#"><i class="icon-instagram-with-circle"></i></a>
						...
						<div class="team-section-grid animate-box" style="background-image: url(images/trainer-6.jpg);">
							<div class="overlay-section">
								<div class="desc">
									...
									<p>"If you hate to start over, then dont quit."</p>
									<p class="fh5co-social-icons">
										<a href="#"><i class="icon-twitter-with-circle"></i></a>
										<a href="#"><i class="icon-facebook-with-circle"></i></a>
										<a href="#"><i class="icon-instagram-with-circle"></i></a>
					...
					<div class="row">
						...
						<div class="col-md-4 animate-box">
							...
							<ul class="contact-info">
								<li><i class="icon-map-marker"></i>234 Capital Blv 27615</li>
								<li><i class="icon-phone"></i>919-561-9938</li>
								<li><i class="icon-envelope"></i><a href="#">info@yoursite.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.RealLifeFriends.com</a></li>
							</ul>
						</div>
						<div class="col-md-4 animate-box">
